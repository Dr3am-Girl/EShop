...
<head>
    ...
    <script src="{{URL::to('backend/http://html5shim.googlecode.com/svn/trunk/html5.js')}}"></script>
    <link id="ie-style" href="{{URL::to('backend/css/ie.css')}}" rel="stylesheet">




    <link id="ie9style" href="{{URL::to('backend/css/ie9.css')}}" rel="stylesheet">
...
<script src="{{URL::to('js/jquery-migrate-1.0.0.min.js')}}"></script>
<script src="{{URL::to('js/jquery-ui-1.10.0.custom.min.js')}}"></script>
<script src="{{URL::to('js/modernizr.js')}}"></script>
<script src="{{URL::to('js/bootstrap.min.js')}}"></script>
<script src="{{URL::to('js/jquery.cookie.js')}}"></script>
<script src="{{URL::to('js/excanvas.js')}}"></script>
<script src="{{URL::to('js/jquery.uniform.min.js')}}"></script>
